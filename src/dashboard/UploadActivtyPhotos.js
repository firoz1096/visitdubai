...
const UploadActivtyPhotos = () => {
  ...
  //protect page if user is not logged in ends
    ...
    const uploadImage = () =>{
     ...
     if(img !==null){
        const imgRef =  ref(imageDb,`activityphotos/${v4()}`)
    ...
    useEffect(()=>{
        ...
        listAll(ref(imageDb,"activityphotos")).then(imgs=>{
...
<>
    ...
    <div className="container mt-5 mb-5">
        ...
        <p> copy the URL showing next to image to use for activity products. </p>
...
export default UploadActivtyPhotos;