...
const UploadVisaPhotos = () => {
    ...
    const uploadImage = () =>{
     ...
     if(img !==null){
        const imgRef =  ref(imageDb,`visaphotos/${v4()}`)
    ...
    useEffect(()=>{
        ...
        listAll(ref(imageDb,"visaphotos")).then(imgs=>{
...
<div className="container mt-5 mb-5">
    ...
    <p> copy the URL showing next to image to use for visa products. </p>
...
export default UploadVisaPhotos;