...
export default function ViewVisa() {
  ...
  const loadVisaDetails = async () => {
    const docRef = doc(database, "visatbl", id);  
...
style={{ backgroundImage: `url(${values.name5})` }}> 
  ...
  <div className='wrap_bg'>
    ...
    <div className='row'>
        ...
        <small>For {values.name2} Days With {values.name7} Entry</small> 
        </div>
...
<div className='col-lg-8'>
    ...
    <span><Link to="/visa">Visa Assistance</Link> </span>
    {/* <span>{values.name1} </span> */}
      ...
      <h3>Description</h3> 
      <div dangerouslySetInnerHTML={{__html: values.name4}}></div>
      </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <img className='img-fluid' src={values.name5}  alt={values.name1} />
