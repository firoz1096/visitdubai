...
export default function ViewDestinations() {
  ...
  const loadActivityDetails = async () => {
    const docRef = doc(database, "destinationtbl", id);  
...
<div className='container'>
  <div className='row'>
    ...
    <FiSun />{values.name5} Nights / <MdOutlineModeNight />{values.name4} Days
    </div>
...
<div className='col-lg-8'>
    ...
    <span><Link to="/destinations">Destinations</Link> </span>
    <span><BiChevronRight /> </span>
    <span>{values.name11} </span>
      ...
      <div className='col-12 mt-5'> 
        <h3>Itinerary </h3> 
        <div dangerouslySetInnerHTML={{__html: values.name9}}></div>    
      </div>
      ...
      <div className='col-12 mt-5'>
      <h3>Inclusions</h3> 
      <div className='inclusion' dangerouslySetInnerHTML={{__html: values.name7}}></div>
      </div>


      <div className='col-12 mt-5'>
      <h3>Exclusions</h3> 
      <div className='exclusions' dangerouslySetInnerHTML={{__html: values.name10}}></div>
      </div>

      <div className='col-12 mt-5'>
      <h3>Terms & Conditions</h3> 
      <div className='terms_conditions' dangerouslySetInnerHTML={{__html: values.name8}}></div>
      </div>
